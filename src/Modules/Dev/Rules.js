    ...
    async execute(client, msg, args) { 
        ...
        const welcome = {
            embed: {
                ...
                description: 'Welcome to our support server. Here you can find an array of resources to help you use our bot Metis! Feel free to check out our #support channel and be sure to read the rules below as well as check out #faq and #role_assignment!'
            }       
        }
        const rules = {
            embed: {
                ...
                footer: '*Revised 11-25-2022 @ 3:45 A.M.*'
            }, 
        ...
        const selfAssign = {
            embed: {
                ...
                description: ":ffAnnounce: @changelog - Mentions you for certain updates regarding the bot.\n\n:no_entry_sign: @hide logs - Hides #mod_log and #server_log.\n\n:no_entry: @hide commands - Hides #bot_commands \n\n:ffSupport: @api user - Gives you access to api channels: #api_changelog and #api_support."
            }
        }
