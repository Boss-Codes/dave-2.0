...
client.on('guildMemberAdd', async (guild, member) => {
    ...
    client.createMessage('713872016788291604', `Welcome to the server, <@${member.id}>! Please read over <#713872065316388874> and be sure to follow them when in the server! You can find visionwise's streams over in <#713871998563909723>. Enjoy your stay, talk in <#713873296680288266>, and if you have any questions do not hesitate to ask a Moderator+, or DM <@575252669443211264>!`)
